  ...
  return knex('videos').del()
    .then(() => {
      return knex('videos').insert([
        ...
        {id: 5, vid_url: '1YGfrGKK9Mo', quote: 'I\'m flying Jack', startTime: 24, quoteStart: 39, quoteEnd: 43, pauseTime: 10},
        {id: 6, vid_url: 'TU7CDejp6Lw', quote: 'Get to the chopper', startTime: 99, quoteStart: 129, quoteEnd: 132, pauseTime: 10}
      ])
    })
}
